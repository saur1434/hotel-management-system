...
A complete, mobile-responsive React frontend built for production. Located in the `frontend/` folder.
...
- Real-time hotel search with autocomplete
...
The frontend automatically proxies API calls to `http://localhost:3000/api`.
...
Creates an optimized `dist/` folder ready for deployment to Vercel, Netlify, or Render.
...
- [Main Server.js](server.js) - Backend API
